...
{
    public abstract class AltaEntidades
    {
        Persona? persona;
        private readonly IPersonaRepository? _personaRepository;
        public AltaEntidades(IPersonaRepository personaRepository)
        {
            _personaRepository = personaRepository;
        }

        public void AltaEntidad(AltaEntidades entidad)
        {
        ...
        void validarInexistencia(AltaEntidades entidad)
        {
        ...
        void validarDatosPersona(AltaEntidades entidad)
        {
        ...
        protected abstract void validarDatosEspecificosDeLaClase(AltaEntidades entidad);
